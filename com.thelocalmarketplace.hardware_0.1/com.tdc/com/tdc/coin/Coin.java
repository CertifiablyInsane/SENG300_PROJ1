...
public class Coin {
	 ...
	 * 
	 * @param value The value of the coin, in multiples of the unit of currency.
	 * @throws SimulationException If the value is &le;0.
	 * @throws SimulationException If the argument is null.
	 */
	 ...
	 * Constructs a coin.
	 * 
	 * @param currency The currency represented by this coin.
	 * @param value    The value of the coin, in multiples of the unit of currency.
	 * @throws SimulationException If the value is &le;0.
	 * @throws SimulationException If either argument is null.
	 */
	 ...
	 *         "denomination" (e.g., a Canadian dime is worth 0.1 Canadian dollars,
	 *         so a Canadian dime would have currency "Canadian dollars").
	 */
