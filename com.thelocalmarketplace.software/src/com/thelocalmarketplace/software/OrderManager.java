...
public class OrderManager 
{
	...
	public void addItem(Item item)
	{
		...
		if(weightChecker.status() == ScaleStatus.BLOCKED){ return; }
		
		if(!readyForNewItem) { return; }
		...
		// SC: In future iterations the rest of the item types needed for add will be implemented
		else
		{
